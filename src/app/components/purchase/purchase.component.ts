...
export class PurchaseComponent implements OnInit {
  ...
  submitPortfolio(name){
      ...
      if(this.portfolio.assets==null||this.portfolio.assets.length<=0||name.length<=0){
          ...
          this.portfolioError.message = this.portfolio.assets==null||this.portfolio.assets.length<=0 ? "You need to have a digital asset in your portfolio" : "Your portfolio must have a name";
